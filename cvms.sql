...
--
-- Dumping data for table `cam_capture_table`
--
...
('Saturday', 'NO CLASS', 'NO CLASS', 'CLASS', 'CLASS', 'NO CLASS', 'NO CLASS'),
...
--
-- Dumping data for table `invalid_id_table`
--
...
--
-- Dumping data for table `main_entry_table`
--
...
--
-- Dumping data for table `raw_id_dev_1_table`
--
-- --------------------------------------------------------
...
--
-- Dumping data for table `raw_id_dev_2_table`
--
...
--
-- Dumping data for table `raw_id_table`
--
-- --------------------------------------------------------
...
--
-- Dumping data for table `report_dev_entry_table`
--
-- --------------------------------------------------------
...
--
ALTER TABLE `cam_capture_table`
  MODIFY `sno` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3638;
...
--
ALTER TABLE `raw_id_dev_2_table`
  MODIFY `sno` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
...
--
ALTER TABLE `report_dev_entry_table`
  MODIFY `sno` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
COMMIT;
